  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-surface-container-lowest">
      <div className="bg-white p-10 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] w-full max-w-md border border-border-subtle relative overflow-hidden">
        ...
        <h1 className="text-3xl font-bold mb-2 text-center text-text-primary tracking-tight">Create an account</h1>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          <div className="group">
            <label className="block text-sm font-semibold text-text-primary mb-1.5 transition-colors group-focus-within:text-primary-container">Full Name</label>
            <div className="relative">
              <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-text-muted text-[20px]">badge</span>
              <input
                type="text"
                required
          ...
          <div className="group">
            <label className="block text-sm font-semibold text-text-primary mb-1.5 transition-colors group-focus-within:text-primary-container">Password</label>
            <div className="relative">
